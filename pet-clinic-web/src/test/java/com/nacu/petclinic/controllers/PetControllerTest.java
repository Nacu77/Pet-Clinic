...
class PetControllerTest {
    ...
    void populatePetTypes() throws Exception {
        ...
        assertEquals(petTypes.size(), petController.populatePetTypes().size());
    }
    ...
    void findOwner() throws Exception {
        ...
        Owner ownerFound = petController.findOwner(1L);
        assertEquals(owner.getId(), ownerFound.getId());
        assertEquals(owner.getFirstName(), ownerFound.getFirstName());
    }
